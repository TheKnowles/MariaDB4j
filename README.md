...
Artifact names have changed to avoid confusion (dev.atchison from ch.vorburger). Code packages, et al have remained unchanged. Updating to 2.7.x should be a drop in replacement for any existing code bases.  

Best effort has been made to clean up the README/documentation to account for the above changes, but things may have been missed.
